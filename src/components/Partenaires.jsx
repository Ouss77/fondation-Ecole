...
const Partenaires = ({  }) => {
  return (
    <div className="w-10/12  mt-10 mx-auto pb-20 rounded-xl bg-slate-100">
      <h2 className="text-3xl font-semibold text-yellow-600 mx-9 xl:mx-32  mb-8 pt-10">Nos Partenaires</h2>
