...
function devenirMembre() {
  ...
  <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      ...
      <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Tu veux nous rejoindre? Tu veux devenir memebre de l'association? Contactez nous et laisser nous un message par email.</p>
