                  ...
                  >
                    ...
                    <td className="px-3 py-3 text-xs text-slate-700">
                      <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800 truncate">
                        {article.theme.length > 8 ? article.theme.substring(0, 8) + '...' : article.theme}
                      </span>
                    </td>
                    <td className="px-3 py-3 text-xs text-slate-700">
                      <div className="font-medium truncate" title={article.titre}>
                        {article.titre.length > 40 ? article.titre.substring(0, 40) + '...' : article.titre}
                      </div>
                    </td>
                    <td className="px-3 py-3 text-xs text-slate-700">
                      <div className="truncate" title={article.resume}>
                        {article.resume.length > 60 ? article.resume.substring(0, 60) + '...' : article.resume}
                      </div>
                    </td>
                    <td className="px-3 py-3 text-xs text-slate-700">
                      <div className="truncate" title={article.authors}>
                        {article.authors.length > 15 ? article.authors.substring(0, 15) + '...' : article.authors}
                      </div>
                    </td>
