...
function equipesLaboratoire() {
  return (
    <div className="w-11/12  pt-28">
      <section className="conference-section">
        <h2>
          Equipes et Laboratoire
        </h2>
        ...
        <p className="text-gray-800 mb-4 text-base leading-7 sm:leading-8 md:leading-9">
        ...
        <p className="text-gray-800 text-base  leading-7 sm:leading-8 md:leading-9">
...
export default equipesLaboratoire