...
function Historique() {
  return (
    <section className=" text-yellow px-4 sm:px-6 md:px-10 lg:px-16 xl:px-24 rounded-lg pt-52">
      <div className="bg-gray-100 p-6 sm:p-8 md:p-10 lg:p-12 xl:p-16 rounded-xl">
        <h2 className="text-2xl md:text-4xl font-semibold text-yellow-600 mb-4 ">
          Historique
        </h2>
        <p className="text-gray-800 mb-4 text-base sm:text-lg md:text-xl leading-7 sm:leading-8 md:leading-10 text-justify">
        ...
        <p className="text-gray-800 text-base sm:text-lg md:text-xl leading-7 sm:leading-8 md:leading-10 text-justify">
